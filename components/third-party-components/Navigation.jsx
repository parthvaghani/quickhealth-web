        ...
        <Navbar variant="light" expand="md">
          <Navbar.Brand className="pt-3">
            <Link to="/">
              <a>
                <Image
                  src="https://www.grouparoo.com/images/logo-and-wordmark-black-words.png"
                  alt="Grouparoo Logo"
                  width={150}
                  height={32}
                />
          ...
          <Navbar.Collapse id="basic-navbar-nav">
                ...
                <Container className="integrationsNav pt-0 mt-0">
                  <Row>
                    <Col xs="12" md="6" className="text-left">
                      ...
                      <Dropdown.Item>
                        <Link to="/integrations/sources/snowflake">
                      ...
                      <Dropdown.Item>
                        <Link to="/integrations/sources/postgres">
                          <a className="nav-link" role="button">
                      ...
                      <Dropdown.Item>
                        <Link to="/integrations/sources/mysql">
                          <a className="nav-link" role="button">
                            MySQL Integration
                          </a>
                        </Link>
                    ...
                    <Col xs="12" md="6" className="text-left">
                      ...
                      <Dropdown.Item>
                        <Link to="/integrations/destinations/salesforce">
                          <a className="nav-link" role="button">
                      ...
                      <Dropdown.Item>
                        <Link to="/integrations/destinations/marketo">
                          <a className="nav-link" role="button">
                            Marketo Integration
                          </a>
                        </Link>
                      ...
                      <Dropdown.Item>
                        <Link to="/integrations/destinations/zendesk">
                          <a className="nav-link" role="button">
                            Zendesk Integration
                          </a>
                        </Link>
                ...
                <Container className="solutionsNav pt-0 mt-0">
                  <Row>
                    <Col xs="12" md="6" className="text-left">
                      ...
                      <Dropdown.Item>
                        <Link to="/solutions/census-alternative">
                          <a className="nav-link" role="button">
                            vs. Census
                          </a>
                        </Link>
                      ...
                      <Dropdown.Item>
                        <Link to="/solutions/segment-alternative">
                          <a className="nav-link" role="button">
                            vs. Segment
                          </a>
                        </Link>
                      ...
                      <Dropdown.Item>
                        <Link to="/solutions/hightouch-alternative">
                          <a className="nav-link" role="button">
                            vs. Hightouch
                          </a>
                        </Link>
                    ...
                    <Col xs="12" md="6" className="text-left">
                      ...
                      <Dropdown.Item>
                        <Link to="/solutions/modern-data-stack">
                          <a className="nav-link" role="button">
                            Modern Data Stack
                          </a>
                        </Link>
            ...
            <a
              to="https://github.com/grouparoo/grouparoo"
              target="_blank"
              rel="noreferrer"
